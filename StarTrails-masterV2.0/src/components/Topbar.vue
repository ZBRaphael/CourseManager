<template>
  <div class="header">
    ...
    >
      <el-submenu index="/aboutme"  v-if="this.$root.role != -1">
        <template slot="title" >MENU</template>
        <el-menu-item index="/aboutme">个人中心</el-menu-item>
        <el-menu-item @click="logout">退出登录</el-menu-item>
      </el-submenu>
      <el-menu-item index="/coach" v-if="this.$root.role == 1 || this.$root.role == 2">
        <el-badge value="admin" class="item" type="warning">教练员</el-badge>
      </el-menu-item>
      <el-menu-item index="/students" v-if="this.$root.role ==0">
        <el-badge value="student" class="item" >学生</el-badge>
      </el-menu-item>
      <el-menu-item index="/admin" v-if="this.$root.role == 2">
