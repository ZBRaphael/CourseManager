  ...
  <div class="courses">
          ...
          <el-timeline-item placement="top">
            <el-card>
              ...
              >
                ...
                <el-form-item label="上课地点" prop="Title">
                  <el-input v-model="ruleForm.Place" placeholder="请输入上课地点"></el-input>
                </el-form-item>
    ...
    <div class="formData">
      ...
      >
        ...
        <el-table-column prop="Title" label="课程名" width="80"></el-table-column>
        <el-table-column prop="Date" label="上课时间" sortable width="150"></el-table-column>
        <el-table-column prop="Place" label="上课地点" width="150"></el-table-column>
        <el-table-column prop="Enrollments.length" sortable label="选课人数" width="120"></el-table-column>
      ...
      <el-dialog title="课程信息" :visible.sync="dialogFormVisible">
        <el-form :model="updateForm" class="content" :rules="rules" ref="updateForm">
          ...
          <el-form-item label="上课地点" prop="Place" :label-width="formLabelWidth" required>
            <el-input v-model="updateForm.Place" autocomplete="off"></el-input>
          </el-form-item>
    ...
    <!-- 关于查看上课记录 -->
    <el-dialog title="上课记录表" :visible.sync="dialogTableVisible">
      <el-table :data="teaCourseData">
        <el-table-column type="index" :index="indexMethod"></el-table-column>
        <el-table-column property="Title" label="课程名" width="150"></el-table-column>
        <el-table-column property="Date" label="上课时间" width="200"></el-table-column>
        <el-table-column property="Place" label="上课地点" width="200"></el-table-column>
  ...
  export default {
    ...
    methods: {
        ...
        this.$refs[formName].validate(valid => {
          if (valid) {
            ...
            var strData = {
              ...
              Date1: this.sendAddTime(
                this.ruleForm.date1,
                this.ruleForm.date2
              ),
              Date2: this.sendAddTime(
                this.ruleForm.Date1,
                this.ruleForm.Date2
              ),
      ...
      handleClick(row) {
        ...
        this.updateForm.Place = row.Place;
        this.updateForm.date1 = this.getDateOne(row.Date);
        this.updateForm.date2 = this.getDateTwo(row.Date);
        console.log(this.updateForm.date1)
        ...
        this.$refs[formName].validate(valid => {
          if (valid) {
            var updateData = {
              ...
              EnrollmentDate1: this.sendAddTime(
                this.updateForm.date1,
                this.updateForm.date2
              ),
              EnrollmentDate2: this.sendAddTime(
                this.updateForm.Date1,
                this.updateForm.Date2
              ),
              Place: this.updateForm.Place,
